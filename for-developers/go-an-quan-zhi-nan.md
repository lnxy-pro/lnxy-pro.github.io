...
* [1 通用类](broken-reference)
  * [I. 代码实现](broken-reference)
    * [1.1 内存管理](broken-reference)
    * [1.2 文件操作](broken-reference)
    * [1.3 系统接口](broken-reference)
    * [1.4 通信安全](broken-reference)
    * [1.5 敏感数据保护](broken-reference)
    * [1.6 加密解密](broken-reference)
    * [1.7 正则表达式](broken-reference)
* [2 后台类](broken-reference)
  * [I. 代码实现](broken-reference)
    * [1.1 输入校验](broken-reference)
    * [1.2 SQL操作](broken-reference)
    * [1.3 网络请求](broken-reference)
    * [1.4 服务器端渲染](broken-reference)
    * [1.5 Web跨域](broken-reference)
    * [1.6 响应输出](broken-reference)
    * [1.7 会话管理](broken-reference)
    * [1.8 访问控制](broken-reference)
    * [1.9 并发保护](broken-reference)
...
* 应尽量避免外部可控参数拼接到HTTP响应头中，如业务需要则需要过滤掉、等换行符，或者拒绝携带换行符号的外部输入。
